...
public class GreedySilverSerpentRing {
    ...
    public static RingItem addAttributeModifier(){
        ...
        builder.put(LHMiracleRoadAttributes.SOUL_INCREASE, new AttributeModifier(UUID.fromString("7bd3dcff-f220-1053-1047-bfbefbee7d7e"), "", .15, AttributeModifier.Operation.MULTIPLY_TOTAL));
