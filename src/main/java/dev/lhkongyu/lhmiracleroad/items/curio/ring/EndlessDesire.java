...
public class EndlessDesire {
    ...
    public static RingItem addAttributeModifier(){
        ...
        builder.put(LHMiracleRoadAttributes.CRITICAL_HIT_RATE, new AttributeModifier(UUID.fromString("5ebd404f-b94f-c286-38f5-38eecbf9d341"), "", 10, AttributeModifier.Operation.ADDITION));
        builder.put(LHMiracleRoadAttributes.DAMAGE_REDUCTION, new AttributeModifier(UUID.fromString("1f3b0a36-90a7-4ca9-ea21-a7ffdadf7b95"), "", -.15, AttributeModifier.Operation.MULTIPLY_TOTAL));
