...
public class FlameTalisman {
    ...
    public static TalismanItem addAttributeModifier(){
        ...
        builder.put(LHMiracleRoadAttributes.ABNORMAL_BURN_DAMAGE, new AttributeModifier(UUID.fromString("9a52ab78-8305-4fed-9c27-2c3521321828"), "", 0.1, AttributeModifier.Operation.MULTIPLY_BASE));
