...
public class FlameTalisman {
    ...
    public static TalismanItem addAttributeModifier(){
        ...
        builder.put(LHMiracleRoadAttributes.ABNORMAL_BURN_BUILDUP, new AttributeModifier(UUID.fromString("4bcfac66-bb9b-420b-9628-44bb606c0ac9"), "", 0.4, AttributeModifier.Operation.MULTIPLY_BASE));
