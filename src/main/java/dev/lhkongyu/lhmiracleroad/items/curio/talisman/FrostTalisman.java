...
public class FrostTalisman {
    ...
    public static TalismanItem addAttributeModifier(){
        ...
        builder.put(LHMiracleRoadAttributes.ABNORMAL_FROST_DAMAGE, new AttributeModifier(UUID.fromString("96afa293-46b3-4022-af12-e0d0da7f2266"), "", 0.1, AttributeModifier.Operation.MULTIPLY_BASE));
