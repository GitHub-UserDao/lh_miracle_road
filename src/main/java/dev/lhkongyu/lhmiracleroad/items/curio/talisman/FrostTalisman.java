...
public class FrostTalisman {
    ...
    public static TalismanItem addAttributeModifier(){
        ...
        builder.put(LHMiracleRoadAttributes.ABNORMAL_FROST_BUILDUP, new AttributeModifier(UUID.fromString("af6b60eb-c678-4c6c-91c2-9ce3b90959fa"), "", 0.4, AttributeModifier.Operation.MULTIPLY_BASE));
