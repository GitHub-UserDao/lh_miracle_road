...
public class RecoveryRing {
    ...
    public static RingItem addAttributeModifier(){
        ...
        builder.put(LHMiracleRoadAttributes.HEALING, new AttributeModifier(UUID.fromString("b90dca3b-f02d-e9cc-b679-54beff1556dd"), "", .5, AttributeModifier.Operation.MULTIPLY_TOTAL));
