...
public class BloodTalisman {
    ...
    public static TalismanItem addAttributeModifier(){
        ...
        builder.put(LHMiracleRoadAttributes.ABNORMAL_BLEED_BUILDUP, new AttributeModifier(UUID.fromString("8b2a6bbc-b590-41da-8d72-4a4cecefc395"), "", 0.4, AttributeModifier.Operation.MULTIPLY_BASE));
