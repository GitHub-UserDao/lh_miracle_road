...
public class BloodTalisman {
    ...
    public static TalismanItem addAttributeModifier(){
        ...
        builder.put(LHMiracleRoadAttributes.ABNORMAL_BLEED_DAMAGE, new AttributeModifier(UUID.fromString("65fa299e-4727-48b3-909d-f6854475b0ca"), "", 0.1, AttributeModifier.Operation.MULTIPLY_BASE));
