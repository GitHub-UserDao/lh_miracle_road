package dev.lhkongyu.lhmiracleroad.client.particle.dark;
...
public class DarkParticle extends AbstractSheetParticle {

    public DarkParticle(ClientLevel level, double x, double y, double z, SpriteSet spriteSet, double xd, double yd, double zd) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level, double x, double y, double z, double dx, double dy, double dz) {
            return new DarkParticle(level, x, y, z, this.sprite, dx, dy, dz);
        }
    }
}
