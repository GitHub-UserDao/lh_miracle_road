...
//            currentGuiScale = minecraft.options.guiScale().get();
    ...
    private void showDetailedAttribute(GuiGraphics graphics){
        ...
        for (String key : showDetailedAttributePage.keySet()) {
            ...
            for (JsonElement showGuiAttributeJsonElement : showDetailedAttributePage.get(key)) {
                ...
                if (attributeName.equals(NameTool.MOVEMENT_SPEED)) percentageBase = 1000;
                if (attributeName.equals(NameTool.CRITICAL_HIT_RATE)) percentageBase = 1;
                showValue = LHMiracleRoadTool.getShowValueType(showValueType,value, percentageBase);
    ...
    private void pointsAttributeName(String attributeTypeName){
        ...
        PlayerChannel.sendToServer(new PlayerAttributePointsMessage(attributeTypeName));
